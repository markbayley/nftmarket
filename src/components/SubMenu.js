...
console.log("backSMtid", backLink, tokenId)
...
let navigate = useNavigate();
  return (
    <div className="flex flex-row place-items-center justify-between flex-wrap w-full pt-3 pl-2">
        ...
        <div className="flex items-center whitespace-nowrap">
          ...
          {data && (
            <Link to={"/Trade"}>
              ...
              >
                #{checksumAddress && shortenAddress(checksumAddress) || data?.name}
              </button>
            </Link>
          )}
        </div>
      ...
      {tab1 === "Create" && (
        <ol className="flex items-center justify-end w-full md:w-1/4 pt-2 ">
          <li
            className={
              tab === "tab1" ? "relative flex w-full items-center  after:w-full   after:border-[#6c63ff] after:border animate-pulse"
              : "relative flex w-full items-center  after:w-full   after:border-amber-500 after:border" }
          >
            <span className={ tab === "tab1" ? "absolute flex items-center justify-center w-8 h-8 bg-amber-500 rounded-full shrink-0 animate-ping" :
            "absolute flex items-center justify-center w-8 h-8 bg-amber-500 rounded-full shrink-0 " } >
              <FaPaintBrush color="#ffffff" />
            </span>
            <span className={ tab === "tab1" ? "absolute flex items-center justify-center w-8 h-8 bg-slate-800 rounded-full shrink-0 border-amber-500 border-2" :
          ...
          <li className={
                 tab === "tab2" ? "relative flex w-full items-center  after:w-full  after:border-[#6c63ff] after:border animate-pulse"
                :  tab === "tab3" ? "relative flex w-full items-center  after:w-full  after:border-amber-500 after:border" 
            ...
            <span
              className={
                tab === "tab1"
                  ...
                  : tab === "tab2" ? "absolute bg-slate-800 flex items-center justify-center w-8 h-8  rounded-full  shrink-0 animate-ping border-amber-500 border-2"
            ...
            <span
              className={
                tab === "tab1"
                  ? "absolute border-2 border-[#6c63ff] bg-slate-800 flex items-center justify-center w-8 h-8  rounded-full  shrink-0"
                  : tab === "tab2" ? "absolute bg-slate-800 flex items-center justify-center w-8 h-8  rounded-full  shrink-0 border-amber-500 border-2"
          ...
          <li className="">
            <span className={ tab === "tab1" || tab === "tab2" ? "flex items-center justify-center w-8 h-8 border-2 border-[#6c63ff] bg-slate-800 rounded-full shrink-0"
